...
function wp_mail($to, $subject, $message, $headers = '', $attachments = array())
{
    ...
    // WRDSB: if you're not James, route your mail to our internal mail system
    if (strpos($to, 'james_schumann') == false) {
        $to = str_replace('@googleapps.wrdsb.ca', '@wrdsb.on.ca', $to);
    }
